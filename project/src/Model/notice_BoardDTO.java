...
//
   public notice_BoardDTO(int noticeNumber, int tip_off_number, String noticeDate, String limitedNumber, String plogDate,
      String noticeImage, String addr, double lat, double lng) {
   super();
   this.noticeNumber = noticeNumber;
